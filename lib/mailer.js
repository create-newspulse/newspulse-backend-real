...
function getMailConfig() {
  ...
  const smtpFrom = firstNonEmpty(process.env.EMAIL_FROM, process.env.SMTP_FROM, process.env.ADS_SMTP_FROM, process.env.ADS_SMTP_USER, smtpUser);
  ...
  if (!smtpFrom) missing.push('EMAIL_FROM|SMTP_FROM');
