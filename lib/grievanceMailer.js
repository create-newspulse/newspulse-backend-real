...
function buildTextBody(payload) {
  return [
    ...
    '',
    `Reference ID: ${formatTextValue(payload.referenceId)}`,
...
function buildHtmlBody(payload) {
  return [
    ...
    `<tr><td style="padding:6px 10px;border:1px solid #ddd;font-weight:700">Reference ID</td><td style="padding:6px 10px;border:1px solid #ddd">${formatHtmlValue(payload.referenceId)}</td></tr>`,
